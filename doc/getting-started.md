...
> To adhere to the zero-trust security model, both variables `ALLOW_LOCAL_SSH_ACCESS` and `ALLOW_LOCAL_SERVICES_ACCESS` should be set to false. The option is available for testing purposes to facilitate development.
